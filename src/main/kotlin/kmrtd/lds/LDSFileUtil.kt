...
object LDSFileUtil {
    ...
    fun lookupFIDByTag(tag: Int): Short =
        when (tag) {
            LDSFile.EF_COM_TAG -> PassportService.EF_COM
            LDSFile.EF_DG1_TAG -> PassportService.EF_DG1
            LDSFile.EF_DG2_TAG -> PassportService.EF_DG2
            LDSFile.EF_DG3_TAG -> PassportService.EF_DG3
            LDSFile.EF_DG4_TAG -> PassportService.EF_DG4
            LDSFile.EF_DG5_TAG -> PassportService.EF_DG5
            LDSFile.EF_DG6_TAG -> PassportService.EF_DG6
            LDSFile.EF_DG7_TAG -> PassportService.EF_DG7
            LDSFile.EF_DG8_TAG -> PassportService.EF_DG8
            LDSFile.EF_DG9_TAG -> PassportService.EF_DG9
            LDSFile.EF_DG10_TAG -> PassportService.EF_DG10
            LDSFile.EF_DG11_TAG -> PassportService.EF_DG11
            LDSFile.EF_DG12_TAG -> PassportService.EF_DG12
            LDSFile.EF_DG13_TAG -> PassportService.EF_DG13
            LDSFile.EF_DG14_TAG -> PassportService.EF_DG14
            LDSFile.EF_DG15_TAG -> PassportService.EF_DG15
            LDSFile.EF_DG16_TAG -> PassportService.EF_DG16
            LDSFile.EF_SOD_TAG -> PassportService.EF_SOD
    ...
    fun lookupDataGroupNumberByTag(tag: Int): Int =
        when (tag) {
            LDSFile.EF_DG1_TAG -> 1
            LDSFile.EF_DG2_TAG -> 2
            LDSFile.EF_DG3_TAG -> 3
            LDSFile.EF_DG4_TAG -> 4
            LDSFile.EF_DG5_TAG -> 5
            LDSFile.EF_DG6_TAG -> 6
            LDSFile.EF_DG7_TAG -> 7
            LDSFile.EF_DG8_TAG -> 8
            LDSFile.EF_DG9_TAG -> 9
            LDSFile.EF_DG10_TAG -> 10
            LDSFile.EF_DG11_TAG -> 11
            LDSFile.EF_DG12_TAG -> 12
            LDSFile.EF_DG13_TAG -> 13
            LDSFile.EF_DG14_TAG -> 14
            LDSFile.EF_DG15_TAG -> 15
            LDSFile.EF_DG16_TAG -> 16
            else -> throw NumberFormatException("Unknown tag " + Integer.toHexString(tag))
        }
    ...
    fun lookupTagByDataGroupNumber(number: Int): Int =
        when (number) {
            ...
            4 -> LDSFile.EF_DG4_TAG
            5 -> LDSFile.EF_DG5_TAG
            6 -> LDSFile.EF_DG6_TAG
            7 -> LDSFile.EF_DG7_TAG
            8 -> LDSFile.EF_DG8_TAG
            9 -> LDSFile.EF_DG9_TAG
            10 -> LDSFile.EF_DG10_TAG
            11 -> LDSFile.EF_DG11_TAG
            12 -> LDSFile.EF_DG12_TAG
            13 -> LDSFile.EF_DG13_TAG
            14 -> LDSFile.EF_DG14_TAG
            15 -> LDSFile.EF_DG15_TAG
            16 -> LDSFile.EF_DG16_TAG
    ...
    fun lookupTagByFID(fid: Short): Short =
        when (fid) {
            PassportService.EF_COM -> LDSFile.EF_COM_TAG.toShort()
            PassportService.EF_DG1 -> LDSFile.EF_DG1_TAG.toShort()
            PassportService.EF_DG2 -> LDSFile.EF_DG2_TAG.toShort()
            PassportService.EF_DG3 -> LDSFile.EF_DG3_TAG.toShort()
            PassportService.EF_DG4 -> LDSFile.EF_DG4_TAG.toShort()
            PassportService.EF_DG5 -> LDSFile.EF_DG5_TAG.toShort()
            PassportService.EF_DG6 -> LDSFile.EF_DG6_TAG.toShort()
            PassportService.EF_DG7 -> LDSFile.EF_DG7_TAG.toShort()
            PassportService.EF_DG8 -> LDSFile.EF_DG8_TAG.toShort()
            PassportService.EF_DG9 -> LDSFile.EF_DG9_TAG.toShort()
            PassportService.EF_DG10 -> LDSFile.EF_DG10_TAG.toShort()
            PassportService.EF_DG11 -> LDSFile.EF_DG11_TAG.toShort()
            PassportService.EF_DG12 -> LDSFile.EF_DG12_TAG.toShort()
            PassportService.EF_DG13 -> LDSFile.EF_DG13_TAG.toShort()
            PassportService.EF_DG14 -> LDSFile.EF_DG14_TAG.toShort()
            PassportService.EF_DG15 -> LDSFile.EF_DG15_TAG.toShort()
            PassportService.EF_DG16 -> LDSFile.EF_DG16_TAG.toShort()
            PassportService.EF_SOD -> LDSFile.EF_SOD_TAG.toShort()
    ...
    fun lookupDataGroupNumberByFID(fid: Short): Int =
        when (fid) {
            PassportService.EF_DG1 -> 1
            PassportService.EF_DG2 -> 2
            PassportService.EF_DG3 -> 3
            PassportService.EF_DG4 -> 4
            PassportService.EF_DG5 -> 5
            PassportService.EF_DG6 -> 6
            PassportService.EF_DG7 -> 7
            PassportService.EF_DG8 -> 8
            PassportService.EF_DG9 -> 9
            PassportService.EF_DG10 -> 10
            PassportService.EF_DG11 -> 11
            PassportService.EF_DG12 -> 12
            PassportService.EF_DG13 -> 13
            PassportService.EF_DG14 -> 14
            PassportService.EF_DG15 -> 15
            PassportService.EF_DG16 -> 16
            else -> throw NumberFormatException("Unknown fid ${Integer.toHexString(fid.toInt())}")
        }
    ...
    fun lookupFileNameByTag(tag: Int): String =
        when (tag) {
            LDSFile.EF_COM_TAG -> "EF_COM"
            LDSFile.EF_DG1_TAG -> "EF_DG1"
            LDSFile.EF_DG2_TAG -> "EF_DG2"
            LDSFile.EF_DG3_TAG -> "EF_DG3"
            LDSFile.EF_DG4_TAG -> "EF_DG4"
            LDSFile.EF_DG5_TAG -> "EF_DG5"
            LDSFile.EF_DG6_TAG -> "EF_DG6"
            LDSFile.EF_DG7_TAG -> "EF_DG7"
            LDSFile.EF_DG8_TAG -> "EF_DG8"
            LDSFile.EF_DG9_TAG -> "EF_DG9"
            LDSFile.EF_DG10_TAG -> "EF_DG10"
            LDSFile.EF_DG11_TAG -> "EF_DG11"
            LDSFile.EF_DG12_TAG -> "EF_DG12"
            LDSFile.EF_DG13_TAG -> "EF_DG13"
            LDSFile.EF_DG14_TAG -> "EF_DG14"
            LDSFile.EF_DG15_TAG -> "EF_DG15"
            LDSFile.EF_DG16_TAG -> "EF_DG16"
            LDSFile.EF_SOD_TAG -> "EF_SOD"
    ...
    fun lookupFileNameByFID(fid: Int): String =
        when (fid) {
            PassportService.EF_COM.toInt() -> return "EF_COM"
            PassportService.EF_DG1.toInt() -> return "EF_DG1"
            PassportService.EF_DG2.toInt() -> return "EF_DG2"
            PassportService.EF_DG3.toInt() -> return "EF_DG3"
            PassportService.EF_DG4.toInt() -> return "EF_DG4"
            PassportService.EF_DG5.toInt() -> return "EF_DG5"
            PassportService.EF_DG6.toInt() -> return "EF_DG6"
            PassportService.EF_DG7.toInt() -> return "EF_DG7"
            PassportService.EF_DG8.toInt() -> return "EF_DG8"
            PassportService.EF_DG9.toInt() -> return "EF_DG9"
            PassportService.EF_DG10.toInt() -> return "EF_DG10"
            PassportService.EF_DG11.toInt() -> return "EF_DG11"
            PassportService.EF_DG12.toInt() -> return "EF_DG12"
            PassportService.EF_DG13.toInt() -> return "EF_DG13"
            PassportService.EF_DG14.toInt() -> return "EF_DG14"
            PassportService.EF_DG15.toInt() -> return "EF_DG15"
            PassportService.EF_DG16.toInt() -> return "EF_DG16"
            PassportService.EF_SOD.toInt() -> return "EF_SOD"
    ...
    fun lookupSFIByFID(fid: Short): Int {
        val sfiByte: Byte = FID_TO_SFI[fid]!!
        if (sfiByte == null) {
    ...
    fun lookupFIDBySFI(sfi: Byte): Short =
        when (sfi) {
            PassportService.SFI_COM -> PassportService.EF_COM
            PassportService.SFI_DG1 -> PassportService.EF_DG1
            PassportService.SFI_DG2 -> PassportService.EF_DG2
            PassportService.SFI_DG3 -> PassportService.EF_DG3
            PassportService.SFI_DG4 -> PassportService.EF_DG4
            PassportService.SFI_DG5 -> PassportService.EF_DG5
            PassportService.SFI_DG6 -> PassportService.EF_DG6
            PassportService.SFI_DG7 -> PassportService.EF_DG7
            PassportService.SFI_DG8 -> PassportService.EF_DG8
            PassportService.SFI_DG9 -> PassportService.EF_DG9
            PassportService.SFI_DG10 -> PassportService.EF_DG10
            PassportService.SFI_DG11 -> PassportService.EF_DG11
            PassportService.SFI_DG12 -> PassportService.EF_DG12
            PassportService.SFI_DG13 -> PassportService.EF_DG13
            PassportService.SFI_DG14 -> PassportService.EF_DG14
            PassportService.SFI_DG15 -> PassportService.EF_DG15
            PassportService.SFI_DG16 -> PassportService.EF_DG16
            PassportService.SFI_SOD -> PassportService.EF_SOD
            PassportService.SFI_CVCA -> PassportService.EF_CVCA
    ...
    fun getDataGroupNumbers(sodFile: SODFile): MutableList<Int> {
        ...
        val dgNumbers: MutableList<Int> = mutableListOf()
        if (sodFile == null) {
            return dgNumbers
        }
    ...
    fun getDataGroupNumbers(comFile: COMFile): MutableList<Int> {
        ...
        dgNumbers.sort() // NOTE: sort it, just in case.
        return dgNumbers
    }
