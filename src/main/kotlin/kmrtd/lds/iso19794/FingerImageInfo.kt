 ...
 */
class FingerImageInfo : AbstractImageInfo {/* Should be equal to (getImageLength() + 14) */
    ...
    constructor(
        position: Int,
        viewCount: Int, viewNumber: Int, quality: Int, impressionType: Int,
        width: Int, height: Int, imageBytes: InputStream, imageLength: Int, compressionAlgorithm: Int
    ) : super(
        ...
        imageBytes,
        imageLength.toLong(),
        toMimeType(compressionAlgorithm)
    ) {
    ...
    public override fun toString(): String {
        return StringBuilder()
            ...
            .append(" \"").append(toMimeType(compressionAlgorithm)).append("\"")
            .append("]")
            .toString()
    }
