...
class IrisBiometricSubtypeInfo : AbstractListInfo<IrisImageInfo?> {
     ...
     */
    constructor(biometricSubtype: Int, imageFormat: Int, irisImageInfos: MutableList<IrisImageInfo?>) {
    ...
    public override fun writeObject(outputStream: OutputStream?) {
        ...
        val irisImageInfos: MutableList<IrisImageInfo> = getSubRecords()
    ...
    val recordLength: Long
        ...
        get() {
            ...
            val irisImageInfos: MutableList<IrisImageInfo> = getSubRecords()
            for (irisImageInfo in irisImageInfos) {
                result += irisImageInfo.recordLength
            }
            return result
        }
    ...
    companion object {
        ...
        private fun biometricSubtypeToString(biometricSubtype: Int): String {
            when (biometricSubtype) {
                ...
                else -> throw NumberFormatException("Unknown biometric subtype: " + Integer.toHexString(biometricSubtype))
            }
        }
    }
}
