 ...
 */(
    ...
    companion object {
        ...
        fun createMRZKey(mrz: BACKeySpec?): PACEKeySpec {
            return PACEKeySpec(PACEProtocol.computeKeySeedForPACE(mrz), PassportService.MRZ_PACE_KEY_REFERENCE)
        }
        ...
        fun createCANKey(can: String): PACEKeySpec {
            return PACEKeySpec(can, PassportService.CAN_PACE_KEY_REFERENCE)
        }
        ...
        fun createPINKey(pin: String): PACEKeySpec {
            return PACEKeySpec(pin, PassportService.PIN_PACE_KEY_REFERENCE)
        }
        ...
        fun createPUKKey(puk: String): PACEKeySpec {
            return PACEKeySpec(puk, PassportService.PUK_PACE_KEY_REFERENCE)
        }
        ...
        private fun keyReferenceToString(keyReference: Byte): String {
            when (keyReference) {
                ...
                PassportService.CAN_PACE_KEY_REFERENCE -> return "CAN"
                PassportService.PIN_PACE_KEY_REFERENCE -> return "PIN"
                PassportService.PUK_PACE_KEY_REFERENCE -> return "PUK"
                PassportService.NO_PACE_KEY_REFERENCE -> return "NO"
                else -> return keyReference.toInt().toString()
            }
        }
    }
}
