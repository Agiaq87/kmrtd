...
abstract class SecureMessagingWrapper protected constructor(
     ...
     */
    val maxTranceiveLength: Int, private val shouldCheckMAC: Boolean,
    /**
    ...
    protected fun checkMac(rapdu: ByteArray, cc: ByteArray): Boolean {
        try {
            ...
            val paddedData = Util.pad(rapdu, 0, rapdu.size - 2 - 8 - 2, this.padLength)
   ...
   */
    ...
    private fun wrapCommandAPDU(commandAPDU: CommandAPDU): CommandAPDU {
        ...
        try {
            ...
            val n = Util.pad(byteArrayOutputStream.toByteArray(), this.padLength)
    ...
    override fun hashCode(): Int {
        ...
        result = prime * result + (this.sendSequenceCounter xor (this.sendSequenceCounter ushr 32)).toInt()
        return result
    }
