 ...
 */(private val service: APDULevelEACTACapable, private val wrapper: SecureMessagingWrapper?) {
    ...
    fun doTA(
        caReference: CVCPrincipal?, terminalCertificates: MutableList<CardVerifiableCertificate>,
        terminalKey: PrivateKey, taAlg: String?, chipAuthenticationResult: EACCAResult, idPICC: ByteArray
    ): EACTAResult {
    ...
    companion object {
        ...
        fun deriveIdentifier(documentNumber: String?): ByteArray {
            ...
            try {
                System.arraycopy(documentNumber.toByteArray(charset("ISO-8859-1")), 0, idPICC, 0, documentNumberLength)
