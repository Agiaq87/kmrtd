...
class ReadBinaryAPDUSender(private val service: CardService) : APDULevelReadBinaryCapable {
    ...
    override fun sendReadBinary(
        ...
        if (isTLVEncodedOffsetNeeded) {
            ...
            commandAPDU = CommandAPDU(ISO7816.CLA_ISO7816.toInt(), ISO7816.INS_READ_BINARY2.toInt(), 0, 0, data, le)
    ...
    companion object {
         ...
         */
        @Throws(CardServiceException::class)
        private fun getResponseData(responseAPDU: ResponseAPDU?, isTLVEncodedOffsetNeeded: Boolean): ByteArray? {
            if (responseAPDU == null) {
                return null
            }
